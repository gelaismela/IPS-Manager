...
/**
 * Utility class to generate VAPID keys for Web Push notifications
 * Uses pure Java - NO external dependencies needed!
 * Run this ONCE to generate your keys, then add them to application.properties
 */
